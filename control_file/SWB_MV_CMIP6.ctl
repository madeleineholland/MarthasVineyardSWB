...
----------------------------------------------------------------
TMAX NETCDF CMIP6/tasmax.{{projection}}.{{RCP}}.r1i1p1f1.2015-2100.LOCA_16thdeg.nc
...
TMIN NETCDF CMIP6/tasmin.{{projection}}.{{RCP}}.r1i1p1f1.2015-2100.LOCA_16thdeg.nc
...
PRECIPITATION NETCDF CMIP6/pr.{{projection}}.{{RCP}}.r1i1p1f1.2015-2100.LOCA_16thdeg.nc
PRECIPITATION_GRID_PROJECTION_DEFINITION +proj=longlat +datum=WGS84 +no_defs
PRECIPITATION_SCALE_FACTOR         3401.5748256  #86400*.039370079
