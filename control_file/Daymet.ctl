...
TMAX NETCDF daymet/tmax_%Y.nc
TMAX_GRID_PROJECTION_DEFINITION +proj=lcc +lat_1=25 +lat_2=60 +lat_0=42.5 +lon_0=-100 +x_0=0 +y_0=0 +ellps=WGS84 +units=km +no_defs
...
TMIN NETCDF daymet/tmin_%Y.nc
TMIN_GRID_PROJECTION_DEFINITION +proj=lcc +lat_1=25 +lat_2=60 +lat_0=42.5 +lon_0=-100 +x_0=0 +y_0=0 +ellps=WGS84 +units=km +no_defs
...
PRECIPITATION NETCDF daymet/prcp_%Y.nc
PRECIPITATION_GRID_PROJECTION_DEFINITION +proj=lcc +lat_1=25 +lat_2=60 +lat_0=42.5 +lon_0=-100 +x_0=0 +y_0=0 +ellps=WGS84 +units=km +no_defs
